...
+ (void)mj_exchangeInstanceMethod1:(SEL)method1 method2:(SEL)method2
{
    method_exchangeImplementations(class_getInstanceMethod(self, method1), class_getInstanceMethod(self, method2));
}

+ (void)mj_exchangeClassMethod1:(SEL)method1 method2:(SEL)method2
{
...
- (void)mj_executeReloadDataBlock
{
...
+ (void)load
{
    [self mj_exchangeInstanceMethod1:@selector(reloadData) method2:@selector(mj_reloadData)];
}
...
- (void)mj_reloadData
{
    ...
    [self mj_executeReloadDataBlock];
}
@end
